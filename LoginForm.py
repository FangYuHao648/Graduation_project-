...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.label_movie.setGeometry(QRect(0, 20, 321, 551))
...
"}")
        ...
        self.tabWidget.setGeometry(QRect(340, -10, 651, 581))
...
"}")
        ...
        self.checkBox_remenber.setGeometry(QRect(80, 360, 171, 71))
...
" ")
        ...
        self.lineEdit_password.setGeometry(QRect(150, 250, 431, 91))
        font1 = QFont()
        ...
        self.label_log_passwordBack.setGeometry(QRect(152, 258, 421, 71))
        ...
        self.label_log_user.setGeometry(QRect(50, 130, 71, 71))
...
"background-color: transparent;")
        ...
        self.lineEdit_user_log.setGeometry(QRect(150, 120, 431, 91))
        font2 = QFont()
        ...
        self.toolButton_forgetCode.setGeometry(QRect(310, 360, 241, 81))
        ...
        self.label_log_password.setGeometry(QRect(40, 250, 81, 81))
...
"background-color: transparent;")
        ...
        self.pushButton_login.setGeometry(QRect(240, 450, 351, 91))
...
"}")
        ...
        self.label_pic.setGeometry(QRect(300, 20, 85, 85))
...
"border-radius:40px;")
        ...
        self.label_log_userBack.setGeometry(QRect(152, 126, 421, 81))
        ...
        self.toolButton_go2reg.setGeometry(QRect(10, 440, 201, 101))
        ...
        self.label_log_info.setGeometry(QRect(140, 400, 179, 39))
        self.label_log_info.setStyleSheet(u"background-color: transparent;\n"
"color: rgb(255, 0, 127);\n"
"font: 9pt \"\u5fae\u8f6f\u96c5\u9ed1\";")
        self.btn_close_2 = QPushButton(self.tab_login)
        self.btn_close_2.setObjectName(u"btn_close_2")
        self.btn_close_2.setGeometry(QRect(550, 20, 40, 71))
        sizePolicy1 = QSizePolicy(QSizePolicy.Minimum, QSizePolicy.Expanding)
        sizePolicy1.setHorizontalStretch(0)
        sizePolicy1.setVerticalStretch(0)
        sizePolicy1.setHeightForWidth(self.btn_close_2.sizePolicy().hasHeightForWidth())
        self.btn_close_2.setSizePolicy(sizePolicy1)
        self.btn_close_2.setMinimumSize(QSize(25, 25))
        self.btn_close_2.setMaximumSize(QSize(40, 16777215))
        icon1 = QIcon()
        icon1.addFile(u":/login/icons/extractLeft.png", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_close_2.setIcon(icon1)
        self.btn_minimize_2 = QPushButton(self.tab_login)
        self.btn_minimize_2.setObjectName(u"btn_minimize_2")
        self.btn_minimize_2.setGeometry(QRect(470, 20, 40, 81))
        sizePolicy1.setHeightForWidth(self.btn_minimize_2.sizePolicy().hasHeightForWidth())
        self.btn_minimize_2.setSizePolicy(sizePolicy1)
        self.btn_minimize_2.setMinimumSize(QSize(25, 25))
        self.btn_minimize_2.setMaximumSize(QSize(40, 16777215))
        icon2 = QIcon()
        icon2.addFile(u":/login/icons/minmax.png", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_minimize_2.setIcon(icon2)
        ...
        self.lineEdit_user_reg.setGeometry(QRect(110, 130, 451, 81))
        ...
        self.label_reg_passwordBack.setGeometry(QRect(20, 240, 581, 91))
        ...
        self.label_reg_user.setGeometry(QRect(40, 140, 61, 61))
...
"background-color: transparent;")
        ...
        self.lineEdit_password_reg.setGeometry(QRect(110, 240, 451, 81))
        ...
        self.label_pic_reg.setGeometry(QRect(150, 20, 85, 85))
...
"border-radius:40px;")
        ...
        self.toolButton_go2login.setGeometry(QRect(40, 460, 171, 91))
        font4 = QFont()
        font4.setFamilies([u"\u5fae\u8f6f\u96c5\u9ed1"])
        font4.setPointSize(24)
        self.toolButton_go2login.setFont(font4)
        self.toolButton_go2login.setCursor(QCursor(Qt.PointingHandCursor))
        self.toolButton_go2login.setIconSize(QSize(31, 5))
        self.toolButton_go2login.setAutoRepeatInterval(95)
        self.label_reg_password = QLabel(self.tab_reg)
        self.label_reg_password.setObjectName(u"label_reg_password")
        self.label_reg_password.setGeometry(QRect(40, 250, 51, 61))
...
"background-color: transparent;")
        ...
        self.label_reg_userBack.setGeometry(QRect(20, 120, 581, 91))
        ...
        self.pushButton_reg.setGeometry(QRect(270, 460, 321, 81))
        sizePolicy2 = QSizePolicy(QSizePolicy.Fixed, QSizePolicy.Fixed)
        sizePolicy2.setHorizontalStretch(0)
        sizePolicy2.setVerticalStretch(0)
        sizePolicy2.setHeightForWidth(self.pushButton_reg.sizePolicy().hasHeightForWidth())
        self.pushButton_reg.setSizePolicy(sizePolicy2)
        font5 = QFont()
        ...
        self.pushButton_reg.setCursor(QCursor(Qt.PointingHandCursor))
        self.pushButton_reg.setAutoFillBackground(False)
        self.pushButton_reg.setIconSize(QSize(31, 5))
        self.pushButton_reg.setAutoRepeatInterval(95)
        self.label_reg_vercodeBack = QLabel(self.tab_reg)
        self.label_reg_vercodeBack.setObjectName(u"label_reg_vercodeBack")
        self.label_reg_vercodeBack.setGeometry(QRect(20, 350, 471, 81))
        ...
        self.label_reg_vercode.setGeometry(QRect(30, 360, 61, 61))
...
"background-color: transparent;")
        ...
        self.lineEdit_code_reg.setGeometry(QRect(90, 350, 361, 81))
        ...
        self.toolButton_verCode.setGeometry(QRect(460, 330, 191, 111))
        ...
        icon3 = QIcon()
        icon3.addFile(u":/login/icons/captcha_1.png", QSize(), QIcon.Normal, QIcon.Off)
        self.toolButton_verCode.setIcon(icon3)
...
"font: 9pt \"\u5fae\u8f6f\u96c5\u9ed1\";")
        ...
        self.toolButton_loadLogo.setGeometry(QRect(300, 40, 45, 45))
        ...
        icon4 = QIcon()
        icon4.addFile(u":/images/icons/gallery.png", QSize(), QIcon.Normal, QIcon.Off)
        self.toolButton_loadLogo.setIcon(icon4)
        ...
        self.btn_close = QPushButton(self.tab_reg)
        self.btn_close.setObjectName(u"btn_close")
        self.btn_close.setGeometry(QRect(540, 10, 40, 71))
        ...
        self.btn_minimize = QPushButton(self.tab_reg)
        self.btn_minimize.setObjectName(u"btn_minimize")
        self.btn_minimize.setGeometry(QRect(470, 0, 40, 81))
        ...
        self.pushButton_reg.setDefault(False)
    ...
    def retranslateUi(self, Dialog):
        Dialog.setWindowTitle(QCoreApplication.translate("Dialog", u"\u767b\u5f55\u754c\u9762", None))
...
#if QT_CONFIG(tooltip)
        self.btn_close_2.setToolTip(QCoreApplication.translate("Dialog", u"\u5173\u95ed", None))
#endif // QT_CONFIG(tooltip)
        self.btn_close_2.setText("")
#if QT_CONFIG(tooltip)
        self.btn_minimize_2.setToolTip(QCoreApplication.translate("Dialog", u"\u6700\u5c0f\u5316", None))
#endif // QT_CONFIG(tooltip)
